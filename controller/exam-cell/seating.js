...
router.post("/", upload.fields([{
  ...
  try {
    ...
    const workerData = {
      _id: newSeatingArrangement._id.toString(), studentFileName, courseFileName, roomFileName, lowerTitle, createdByEmail: req.user_email, title, dateOfExam
    }
